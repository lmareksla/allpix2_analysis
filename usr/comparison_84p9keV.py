...
dir_data = 	"./test/comparison_xray_84p9keV/"
dir_out = 	"./usr/out_comparison/"
fig_name = 	"comparison_Xray_84p9keV.png"
...
data_1 = Data("", 						"RealMeas/", 			"RealMeas", 	"Measurement", 							dir_data + "cal_mat_meas"); data.append(data_1)
# data_2 = Data("PixelHitCharge.txt", 	"PixelHit.t3pa", 		"PixelHit", 	"Full simulation with CSA and physics", dir_data + "cal_mat_sim");	data.append(data_2)
data_3 = Data("PixelHitCharge.txt", 	"PixelCharge.t3pa", 	"PixelCharge", 	"Only charge/only physics without CSA", dir_data + "/../cal_mat_sim", con_is_charge = True);		data.append(data_3)

# data_1.hist_shift = 2.5
...
if do_comparison:
	...
	for dt in data:
		dt.elist = pd.read_csv(dt.dir + dt.elist_name + ".elist2", sep="\t", header=[0], skiprows = [1], nrows=5000000)
