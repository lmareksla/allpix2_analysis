...
dir_data = 	"./test/comparison_xray_24p2keV/"
dir_out = 	"./usr/out_comparison/"
fig_name = 	"comparison_24keV.png"
...
data_3 = Data("PixelHitCharge_24keV.txt", 	"PixelCharge_24keV.t3pa", 	"PixelCharge_24keV", 	"Only charge/only physics without CSA", dir_data + "/../cal_mat_sim", con_is_charge = True)
