...
dir_data = 	"./test/comparison_xray_59p5keV/"
dir_out = 	"./usr/out_comparison/"
fig_name = 	"comparison_Xray_59p5keV.png"
...
data_1 = Data("", 						"RealMeas.t3pa", 		"RealMeas", 	"Measurement", 							dir_data + "cal_mat_meas")
# data_2 = Data("PixelHitCharge.txt", 	"PixelHit.t3pa", 		"PixelHit", 	"Full simulation with CSA and physics", dir_data + "/../cal_mat_sim")
data_3 = Data("PixelHitCharge.txt", 	"PixelCharge.t3pa", 	"PixelCharge", 	"Only charge/only physics without CSA", dir_data + "/../cal_mat_sim",  con_is_charge = True)

# data = [  data_1, data_2, data_3 ]

# data_1.hist_shift = 1.5
